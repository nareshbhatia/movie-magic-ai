...
### Prompting v0 to Generate Movie Magic
...
### Manually Iterating on v0's Code

#### Iteration 1: Clean up v0 generated code

Given that v0 code compiles and runs in its own environment, it's already a
great start. I needed only minor cleanup to get it running in my dev
environment.
...
3. **Understanding Feedback:** While v0 generally understands prompts well,
...
4. **Flaky Light/Dark Mode Implementation:** Given v0's strong understanding of
